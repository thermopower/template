...
| **code-reviewer** | sonnet | 20 | — | sprint 내부 코드 리뷰. stub/placeholder 잔존 확인 → 구현 품질 자가 검증(AC 추적·dead code·catch·제어흐름) → major 이상 문제 확인. LGTM 또는 NEEDS_WORK 반환. minor 언급 금지. | — | minor 지적, 리팩터링 제안, 범위 확장 요구 |
